...
curl -d '{"fields":{"code":"'${RELEASE_NAME}'","assetsPath":"'${SUB_PATH}'","assets":'${assets}',"status": 2, "version":'${CHART_VERSION}'}}' -H "Content-Type: application/json" -X POST  ${val_WORKER_PLATFORM_URL}/global/menu/v1/menu-resources
